/* =============================================================================
 * features/homework/components/HomeworkClient.tsx — homework list and forms
 * -----------------------------------------------------------------------------
 * Role: Tutor creates/edits/deletes assignments; students upload submissions
 *       before deadline. Handles client-side storage upload then server action.
 * Dependencies: homework actions, lib/homework, lib/storage bucket, components/ui
 * Used by: app/classes/[id]/homework/page.tsx
 * Inputs: role, homework rows with signed attachments, student id
 * Outputs: Homework accordion UI with submit/create dialogs
 * ========================================================================== */
"use client";
...
import { submitHomework, createHomework, updateHomework, deleteHomework } from "@/features/homework/actions";
