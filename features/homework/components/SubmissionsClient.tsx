/* =============================================================================
 * features/homework/components/SubmissionsClient.tsx — grade one homework item
 * -----------------------------------------------------------------------------
 * Role: Tutor views all student submissions for a single homework assignment
 *       and saves grade/feedback via gradeSubmission action.
 * Dependencies: submissions-actions, components/ui
 * Used by: app/classes/[id]/homework/[hwId]/page.tsx
 * Inputs: homework metadata, submissions with signed attachments, students
 * Outputs: Per-student submission cards with grading form
 * ========================================================================== */
"use client";
