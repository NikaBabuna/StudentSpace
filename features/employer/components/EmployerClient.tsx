/* =============================================================================
 * features/employer/components/EmployerClient.tsx — employer portal home
 * -----------------------------------------------------------------------------
 * Role: Grid overview of linked tutors and students with class counts.
 * Dependencies: Inline styles (legacy), next/link
 * Used by: app/employer/page.tsx
 * Inputs: firstName, tutors[], students[], totalClasses from server
 * Outputs: Employer dashboard cards linking to person detail pages
 * ========================================================================== */
"use client";
