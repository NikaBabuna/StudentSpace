/* =============================================================================
 * features/employer/components/PersonDetailClient.tsx — tutor/student detail
 * -----------------------------------------------------------------------------
 * Role: Shows one person’s profile and shared classes for employer oversight.
 * Dependencies: Inline styles (legacy), ClassSummary type
 * Used by: app/employer/students/[userId], tutors/[userId] pages
 * Inputs: person info, classes list, role, backHref
 * Outputs: Detail page with class links
 * ========================================================================== */
"use client";
