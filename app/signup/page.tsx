  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="text-[12px] mb-5 px-3 py-2 rounded-md"
          style={{ background: "#17150f", color: "var(--color-ss-text-faint)", border: "0.5px solid var(--color-ss-border)" }}
        >
        ...
        <form onSubmit={handleSignup} className="flex flex-col gap-4">
          ...
          {error && (
            <div
              ...
              style={{
                background: "var(--color-ss-red-bg)",
                color: "var(--color-ss-red)",
                border: "0.5px solid var(--color-ss-red-border)",
              }}
            >
              {error}
            </div>
