    ...
    <AppLayout mode="dashboard" tutorInitials={userInitials} tutorName={fullName} role="tutor">
      <div className="flex-1 flex flex-col overflow-hidden">
        <div className="px-6 py-4 shrink-0" style={{ borderBottom: "0.5px solid var(--color-ss-border)" }}>
          <h1 className="text-[16px] font-medium" style={{ color: "var(--color-ss-text-primary)" }}>Preferences</h1>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center">
            ...
            <div className="text-[12px]" style={{ color: "#4a4438" }}>Preferences and customisation options are coming in a future update.</div>
          </div>
        </div>
      </div>
    </AppLayout>
