/* =============================================================================
 * app/employer/page.tsx — employer portal home route
 * -----------------------------------------------------------------------------
 * Role: Loads tutors/students linked via shared classes; renders EmployerClient.
 * Dependencies: lib/auth, EmployerClient
 * Used by: Route /employer
 * Inputs: Employer user session
 * Outputs: EmployerClient with people grids and class counts
 * ========================================================================== */
import { redirect } from "next/navigation";
import { getCurrentUser, getServerClient } from "@/lib/auth";
import EmployerClient from "@/features/employer/components/EmployerClient";
